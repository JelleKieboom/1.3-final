...
SoundFile ultraNecrozma;
SoundFile solgaleoLunala;
SoundFile studiopolis;
SoundFile empress;
SoundFile radiance;
SoundFile worldOfLight;
SoundFile mergedZamasu; 
boolean musicButton = false; 
int musicScene = 0; 
float beats = 120; 

boolean musicOnce0 = true; 
boolean musicOnce1 = true; 
boolean musicOnce2 = true; 
boolean musicOnce3 = true; 
boolean musicOnce4 = true; 
boolean musicOnce5 = true; 
boolean musicOnce6 = true; 
...
void setup() {
  ...
  ultraNecrozma = new SoundFile(this, "ultranecrozma.mp3");
  solgaleoLunala = new SoundFile(this, "solgaleolunala.mp3");
  studiopolis = new SoundFile(this, "studiopolis.mp3");
  empress = new SoundFile(this, "empressoflight.mp3");
  radiance = new SoundFile(this, "radiance.mp3");
  worldOfLight = new SoundFile(this, "worldoflight.mp3");
  mergedZamasu = new SoundFile(this, "mergedzamasu.mp3");
...
void draw() {
  ...
  if (arduino.digitalRead(6) == arduino.HIGH && musicButton == false) {
    musicButton = true; 
    musicScene++; 
    if(musicScene > 6) {
      musicScene = 0; 
...
void musicMan() {
  if (musicScene == 0 && musicOnce0) {
    musicOnce6 = true; 
    musicOnce0 = false; 
    mergedZamasu.stop();
    ultraNecrozma.play();
    ultraNecrozma.rate(1.1);
    ultraNecrozma.loop();
    beats = 93; 
  }

  if (musicScene == 1 && musicOnce1) {
    musicOnce0 = true; 
    musicOnce1 = false; 
    ultraNecrozma.stop();
    solgaleoLunala.play();
    solgaleoLunala.rate(1.1);
    solgaleoLunala.loop();
    beats = 180; 
  }
  
  if (musicScene == 2 && musicOnce2) {
    musicOnce1 = true; 
    musicOnce2 = false; 
    solgaleoLunala.stop();
    studiopolis.play();
    studiopolis.rate(1.1);
    studiopolis.loop();
    beats = 120; 
  }

  if (musicScene == 3 && musicOnce3) {
    musicOnce2 = true; 
    musicOnce3 = false; 
    studiopolis.stop();
    empress.play();
  ...
  if (musicScene == 4 && musicOnce4) {
    musicOnce3 = true; 
    musicOnce4 = false; 
    empress.stop();
    worldOfLight.play();
    worldOfLight.rate(1.1);
    worldOfLight.loop();
    beats = 141; 
  }

  if (musicScene == 5 && musicOnce5) {
    musicOnce4 = true; 
    musicOnce5 = false; 
    worldOfLight.stop();
    radiance.play();
  ...
  if (musicScene == 6 && musicOnce6) {
    musicOnce5 = true; 
    musicOnce6 = false; 
    radiance.stop();
    mergedZamasu.play();
    mergedZamasu.rate(1.1);
    mergedZamasu.loop();
    beats = 140; 
  }
}
